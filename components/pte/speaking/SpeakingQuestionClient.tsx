...
import { uploadAudioWithFallback } from '@/lib/audio-upload'
import { SPEAKING_TIMER_MAP } from '@/lib/constants'
import {
  ...
  return (
    <div className="space-y-6">
      ...
      <AIScoringModal
        open={submitting}
        onOpenChange={() => {}}
        isScoring={submitting}
        title="AI Scoring Your Response"
        description="Transcribing audio and analyzing your speaking performance..."
      />
