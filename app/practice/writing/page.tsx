...
import { PenTool, Target, TrendingUp, Zap } from "lucide-react";
import { useAppStore } from "@/lib/store/app-store";

// Mock data for writing tasks
const WRITING_TASKS = [
  { id: "swt", title: "Summarize Written Text", type: "summarize_written_text", total: 60 },
  { id: "we", title: "Write Essay", type: "write_essay", total: 40 },
];
...
export default function WritingPracticePage() {
  ...
  const [userStats, setUserStats] = useState<UserWritingStats>({});
        ...
        <Card className="max-w-md mx-auto">
          <CardContent className="pt-6 text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Please sign in to access writing practice features
            </p>
  ...
  return (
    <PTELayoutClient>
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent rounded-lg p-6 border border-primary/20">
          <div className="flex items-center justify-between">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Improve your writing skills with targeted practice questions.
              </p>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Writing Practice Tasks</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {WRITING_TASKS.map((task, index) => {
                ...
                return (
                  <div key={task.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <Button asChild>
                        <a href={`/pte/practice-new/writing/${task.type}`}>
                          Practice
                        </a>
                      </Button>
                    </div>
