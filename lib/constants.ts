import { SpeakingType } from '@/lib/types'

// --- Assets & Resources ---
export const ASSETS = {
    ICONS: {
        BASE_URL: "https://pedagogistspte.com/icons",
        // Add specific icon paths here if needed, or just use the base URL
    },
    // Add other asset categories here (e.g., IMAGES, VIDEOS)
}

// UI Metadata for Speaking Tasks
export const SPEAKING_TASKS = [
    {
        type: "read_aloud",
        title: "Read Aloud",
        description: "Read the given text aloud clearly and fluently",
    ...
    },
    {
        ...
        description: "Re-tell the lecture you heard",
    ...
    },
    {
        ...
        description: "Answer the question with one word or short phrase",
    ...
    },
    {
        ...
        description: "Summarize the discussion you heard",
        instructions: "You will hear a group discussion. Summarize the main points of the discussion.",
        prepTime: 10,
        recordTime: 60,
        color: "bg-teal-500"
    },
    {
        ...
        description: "Respond appropriately to the given situation",
        instructions: "You will hear a description of a situation. Please respond appropriately to the situation.",
        prepTime: 20,
        recordTime: 40,
        color: "bg-pink-500"
    }
...
// PTE Categories (Question Types Metadata)
export const PTE_CATEGORIES = [
    {
        id: 1,
        title: 'Speaking',
