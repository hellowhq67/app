...
export const pteListeningQuestionsRelations = relations(pteListeningQuestions, ({ one }) => ({
...
export const pteSpeakingQuestionsRelations = relations(pteSpeakingQuestions, ({ one }) => ({
    question: one(pteQuestions, {
...
export const pteWritingQuestionsRelations = relations(pteWritingQuestions, ({ one }) => ({
    question: one(pteQuestions, {
...
export const pteReadingQuestionsRelations = relations(pteReadingQuestions, ({ one }) => ({
    question: one(pteQuestions, {
